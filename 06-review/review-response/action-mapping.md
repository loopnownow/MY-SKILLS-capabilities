...
| `ACCEPT_ANALYSIS` | added/changed an analysis | state method + result + location (route to `04-stats-guide` / `04-model-eval`) |
...
| `SOFTEN_CLAIM` | overclaim flagged | calibrate wording (`05-write-polish`) + cite change |
