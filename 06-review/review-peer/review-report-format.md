...
MAJOR / BLOCKER COMMENTS
  1. [Issue] — Location: [section/figure]. Risk: [guideline item / methodological risk].
     Fix: [concrete action → skill].
  2. ...
...
EDITOR-STYLE RECOMMENDATION
  [Ready / Minor revision / Major revision / Not yet] — because [reasons].
...
- Each Major/Blocker cites the guideline item or methodological risk a real reviewer would.
...
- State the recommendation honestly; do not reassure past a real Blocker.
