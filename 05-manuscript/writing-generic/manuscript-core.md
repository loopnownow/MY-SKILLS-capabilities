...
owner: "05_manuscript/manuscript-core.md"
---
...
详规：[`mode-1-sci.md`](mode-1-sci.md)  
**全文版式（title page / IMRAD / DOCX / 引用配额）：** [`Aitor-format.md`](Aitor-format.md)  
分节润色：[`polisher-sections.md`](polisher-sections.md)  
引言/讨论文献：[`intro-discussion-evidence.md`](intro-discussion-evidence.md)  
去 AI：[`de-ai/ai-isms-checklist.md`](de-ai/ai-isms-checklist.md)
...
默认作者栏、通讯、基金、回顾性 waiver：见 `Aitor-format.md`（勿在此复制）。
...
4. 术语一致；缩写首次全称
5. 短句（英文尽量 ≤55 词）
6. 禁 AI 腔 → 见 `de-ai/forbidden-phrases.md`
...
10. **英文 SCI 全文必须遵守** `Aitor-format.md`（金标准：`0del/lxf_LG/Response/Manuscript_Response_house.docx`：除表芯 11 磅外全稿 12 磅；题目/节标题 12 磅加粗；单位左齐不加粗）。不清楚就问用户。
...
| `de-ai` | `de-ai/README.md`（先 forbidden，再 `ai-isms-checklist.md`，再 stop-slop；检测报告才开 detector） |
...
| mounted `04-figure-engine` | Figure 1 入组/分析流程图（不画纳入标准；training/test 下连分析行；有外部队列才画 validation set） |
| `mode-1-sci.md` | 主工作流 |
...
- ~~stop-slop~~ → `de-ai/stop-slop-core.md` + phrases/structures/examples
- ~~ai-writing-detector~~ → `de-ai/ai-writing-detector.md`
